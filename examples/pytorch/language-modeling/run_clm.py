...
def main():
    ...
    model_axis = max(model_args.spmd_2d_sharding, 2)

    print(f"Model axis is: {model_axis}")
    ...
    if model_args.peft_lora:
        ...
        peft_config = LoraConfig(use_dora = True, task_type=TaskType.CAUSAL_LM, inference_mode=False, r=8, lora_alpha=16, lora_dropout=0.2, 
